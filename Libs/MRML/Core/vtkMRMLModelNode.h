...
public:
 ...
 /// Description:
  ...
  /// or its extracted surface mesh if the mesh
  /// is an unstructured grid.
  /// \sa GetMesh(), GetUnstructuredGrid()
  virtual vtkPolyData* GetPolyData();

  /// Return the input mesh if it is an
  /// unstructured grid.
  /// \sa GetMesh(), GetPolyData()
  ...
  /// is a polydata, or its extracted surface mesh
  /// pipeline if the mesh is an unstructured grid
  /// \sa GetMeshConnection(), GetUnstructuredGridConnection()
  vtkAlgorithmOutput* GetPolyDataConnection();

  /// Return the input mesh pipeline if the mesh
  /// is an unstructured grid
  /// \sa GetMeshConnection(), GetPolyDataConnection()
  vtkAlgorithmOutput* GetUnstructuredGridConnection();
